    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/20 font-sans text-slate-900">
            ...
            <div className="flex min-h-[calc(100vh-64px)] items-center justify-center p-4">
                {/* Background orbs */}
                <motion.div
                    className="fixed -top-40 -left-40 h-96 w-96 rounded-full bg-violet-200/20 blur-3xl pointer-events-none"
                    animate={{ x: [0, 25, 0], y: [0, -20, 0] }}
                    transition={{ duration: 9, repeat: Infinity, ease: "easeInOut" }}
                />
                <motion.div
                    className="fixed -bottom-40 -right-40 h-96 w-96 rounded-full bg-blue-200/20 blur-3xl pointer-events-none"
                    ...
                    <div className="rounded-2xl border border-slate-200/80 bg-white/90 backdrop-blur-xl p-8 shadow-xl shadow-blue-900/5">
                        ...
                        >
                            ...
                            <p className="mt-1 text-sm text-slate-500">
                                Join WorkFinder and start tracking your dream jobs
                            </p>
                        </motion.div>
                        ...
                        <form onSubmit={handleRegister} className="space-y-5">
                            ...
                            >
                                <Button
                                    className="w-full h-11 rounded-xl bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-700 hover:to-indigo-700 shadow-lg shadow-violet-600/20 transition-all hover:shadow-xl hover:scale-[1.01] active:scale-[0.99]"
                                    type="submit"
                                    disabled={loading}
                                >
